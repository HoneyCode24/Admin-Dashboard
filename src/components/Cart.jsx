...
const Cart = () => {
  ...
  return (
    <div className="bg-half-transparent w-[400px] absolute top-16 right-52 z-50 rounded-2xl overflow-hidden">
      <div className="duration-1000 ease-in-out dark:text-gray-200 transition-all dark:bg-[#484B52] bg-white md:w-400 p-8">
        ...
        <div className="mt-3 mb-3">
          <div className="flex justify-between items-center mt-3">
            <p className="text-gray-500 dark:text-gray-200">Total - $890</p>
          </div>
        </div>
        <div className="mt-5">
          <Button
